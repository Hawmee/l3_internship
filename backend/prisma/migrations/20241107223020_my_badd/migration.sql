/*
  ...
  - You are about to drop the column `theme` on the `stagiaires` table. All the data in the column will be lost.
  - Added the required column `theme` to the `Stages` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `stages` ADD COLUMN `theme` VARCHAR(191) NOT NULL;

-- AlterTable
ALTER TABLE `stagiaires` DROP COLUMN `theme`;
