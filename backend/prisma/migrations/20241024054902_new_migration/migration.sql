...
-- AlterTable
ALTER TABLE `attestation` ADD COLUMN `isNew` BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE `entretients` ADD COLUMN `isNew` BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE `stages` ADD COLUMN `book_link` VARCHAR(191) NULL,
    ADD COLUMN `isNew` BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE `users` ADD COLUMN `isNew` BOOLEAN NOT NULL DEFAULT true;
