/*
  ...
  - You are about to drop the column `date_interview` on the `entretients` table. All the data in the column will be lost.
  - You are about to drop the column `offre_id` on the `entretients` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `entretients` DROP COLUMN `date_interview`,
    DROP COLUMN `offre_id`,
    ADD COLUMN `date_entretien` DATETIME(3) NULL;
