/*
  ...
  - You are about to drop the column `metion_requise` on the `offres` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `offres` DROP COLUMN `metion_requise`,
