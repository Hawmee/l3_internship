/*
  ...
  - You are about to drop the column `pertinance_pro` on the `performances` table. All the data in the column will be lost.
  - Added the required column `comportement_pro` to the `Performances` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `performances` DROP COLUMN `pertinance_pro`,
    ADD COLUMN `comportement_pro` VARCHAR(191) NOT NULL;
